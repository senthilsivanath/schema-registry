...
public class RestService implements Configurable {
  ...
  private static final TypeReference<SchemaRegistryVersion> GET_SR_VERSION_RESPONSE_TYPE =
          new TypeReference<SchemaRegistryVersion>() {
          };
  ...
  public SchemaRegistryVersion getSchemaRegistryVersion() throws IOException, RestClientException {
